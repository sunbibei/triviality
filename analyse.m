...
for exper_num = 1:1:length(EXPER_TYPE)
    LABEL_X = char(EXPER_TYPE(exper_num));

    close all;
    is_save=true;
    EXPER_DIR=['experiment' num2str(exper_num) '/Output'];
    IMG_OUT_DIR=['experiment' num2str(exper_num) '/Img'];
    if is_save
